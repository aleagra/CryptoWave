  ...
  return (
    <section className="  flex h-full min-h-screen flex-col justify-center ">
      <div className="mx-auto flex flex-row-reverse justify-center  max-xl:w-[100%] max-xl:flex-col md:pt-0 ">
        <div className="z-[1] w-[100%] outline-none max-md:my-10 max-md:mx-auto max-md:w-[80%] xl:w-[75%] 2xl:w-[90%]">
        ...
        <div className="flex flex-col justify-center gap-y-10 max-xl:m-auto  max-md:gap-y-6 lg:w-[50%]">
          <p className="text-[5rem] font-bold leading-[5rem] text-[#fcfdfe] max-2xl:text-[3.5rem] max-2xl:leading-[4rem] max-md:px-4 max-md:text-center max-md:text-[2.5rem] max-md:leading-[3rem]">
            Invest in the world's most popular assets
          </p>
          <p className="text-[1.5rem] font-bold text-white/50 max-2xl:text-[1.2rem] max-md:px-10 max-md:text-center max-md:text-lg">
          ...
          <a
            href="/Login"
            className="w-[20rem] max-2xl:w-[15rem] max-2xl:py-3 max-md:mx-auto max-md:w-[10rem]"
          >
