      ...
      <section className="mt-40 max-h-screen w-full flex flex-col  px-4 text-white  max-md:w-[100%]">
        <div className="rounded-lg bg-prueba  p-4  max-md:p-2">
          <div className="flex justify-between p-5 flex-wrap max-lg:p-0">
            <h4 className="text-3xl opacity-60 max-sm:text-lg max-sm:m-auto">Total balance ( USD )</h4>
            <h4  className={` p-5 text-center  text-xl font-bold max-sm:m-auto ${
                            user > 0
                              ? "text-[#00A68C]"
                              : "text-[#D9475A]"
                          }`}>  {user}</h4>
          </div>
          <h2 className="px-5 font-bold text-3xl max-md:text-center">
            $ <span>{balance}</span>
          </h2>
